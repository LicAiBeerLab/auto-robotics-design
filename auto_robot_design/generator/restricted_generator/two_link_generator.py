...
class TwoLinkGenerator():
    ...
    def __init__(self) -> None:
        ...
        self.ground_z_movement = (-0.05,0.05)
        self.free_x_movement = (-0.1, 0.1)
        self.free_z_movement = (-0.1, 0.1)
        self.bound_x_movement = (-0.15, 0.1)
        self.bound_z_movement = (-0.05, 0.1)
    ...
    def build_standard_two_linker(self, knee_pos: float = -0.15, nominal_length=0.3, right_shift=-0.1):
        ...
        self.constrain_dict[knee_joint.name] = {
            'optim': True, 'x_range': (-0.2, 0), 'z_range': (-0.1, 0.1)}
