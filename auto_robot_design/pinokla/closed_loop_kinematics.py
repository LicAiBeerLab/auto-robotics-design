...
def closed_loop_ik_pseudo_inverse(rmodel, rdata,rconstraint_model,rconstraint_data, target_pos, ideff,q_start=None, onlytranslation=False,eps=1e-5,max_it=300):
