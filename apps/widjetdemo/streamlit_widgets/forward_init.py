...
def get_russian_reward_description():
    ...
    reward_description['actuated_inertia_matrix'] = ("Определитель матрицы инерции", "Определитель матрицы инерции в обобщённых координатах актуированных сочленений. Характеризует полную инерцию механизма")
