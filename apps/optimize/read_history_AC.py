...
path = "apps/optimize/results/test_2024-05-07_22-05-47_17reverse_RH5"
new_path = "apps/optimize/results/test_2024-05-07_22-05-47_17reverse_RH5_1v"
path_to_ctrl = "apps/optimize/results/test_2024-05-07_22-05-47_17reverse_RH5_1v"
...
if load_ctrl:
    with open(os.path.join(path_to_ctrl, "AC_ctrl_coeffs.pkl"), "rb") as f:
        coeffs = dill.load(f)
